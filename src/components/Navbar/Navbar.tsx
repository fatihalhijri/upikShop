...
const Nav = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (isOpen && !event.composedPath().some(el => (el as HTMLElement).id === "navbar-menu")) {
        setIsOpen(false);
      }
    };
  ...
  const navOpenStyle = isOpen ? "translate-y-0" : "translate-y-[-100%]";
  ...
  return (
    <nav
      className={`fixed  ${stickyStyle} bg-white/95 md:bg-none  transition-all w-full z-[1000] 
       `}
    >
      <div className="">
        {/* <div
      ...
      ></div> */}
        ...
        <div className="" onClick={handleOutsideClick}>
          <div className={`flex items-center  h-[8vh] justify-between    z-[10006] px-6 md:px-20 lg:px-36 `}>
