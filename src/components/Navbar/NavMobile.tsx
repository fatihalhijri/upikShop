...
const NavMobile = ({ closeNav, showNav }: Props) => {
  ...
  return (
    <div className="">
      ...
      >
        <ul
          className={`text-white ${navOpenStyle} fixed flex items-center justify-center flex-col h-[100%] w-[60%] transform transition-all duration-300 delay-300 bg-white/70 dark:bg-darkTua backdrop-blur space-y-14  z-[1000] `}
        >
          <div className="">
