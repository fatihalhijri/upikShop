...
const ProductCard: React.FC<propsType> = ({
  ...
  return (
    <div className="border border-gray-200 rounded-lg w-full max-w-[440px] h-[350px] shadow-md flex flex-col items-center justify-center overflow-hidden">
      <div className="flex items-center justify-center max-h-[200px]  w-full overflow-hidden bg-gray-100">
        <Image
      ...
      <div className="px-4 py-2 flex flex-col justify-start items-start gap-4 w-full">
        <div className="">
          <h2 className="text-blackish text-base md:text-lg lg:font-bold md:font-semibold font-medium ">
            {title}
          </h2>
          ...
          <div className="font-bold flex flex-row gap-3 items-center text-blackish">
            Rp.{price}
            <del className="text-gray-400 md:font-semibold font-medium text-sm">
              Rp.{parseInt(price) + 5000}
            </del>
          </div>
        </div>
        ...
        <div className="flex  gap-2 justify-between items-center w-full">
          <div className="flex justify-between items-center bg-accent py-2 px-3 rounded-lg w-1/2">
            <p className="md:text-base text-[12px] text-white">Stok </p>
            <p className="md:text-base text-[12px] text-white">({stok})</p>
          </div>
          <div className="flex  flex-row justify-between items-center bg-blue-500 py-2 px-3 rounded-lg text-center  w-1/2 ">
            <p className="md:text-base text-[12px] text-white text-center">
              checkout
            </p>
...
//       <div className="container pt-16 py-10 px-4 sm:px-6 md:px-10 lg:px-16">
